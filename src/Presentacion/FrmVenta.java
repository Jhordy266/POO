...
public class FrmVenta extends javax.swing.JInternalFrame {
    ...
    private void calcularTotales() {
        ...
        if (items == 0) {
            ...
            for (int i = 0; i < items; i++) {
                ...
                if (valorCelda != null) {
                    try {
                        Number parsedNumber = nf.parse(valorCelda.toString().trim());
        ...
        if (textoImpuesto == null || textoImpuesto.trim().isEmpty()) {
            ...
            try {
                Number parsedImpuesto = nf.parse(textoImpuesto.trim()); 
                impuesto = parsedImpuesto.doubleValue();
            } catch (ParseException e) { 
        ...
        if (1 + impuesto != 0) {
            ...
            JOptionPane.showMessageDialog(this, "Error de cálculo: El valor del impuesto hace que el denominador sea cero.", "Error", JOptionPane.ERROR_MESSAGE);
            subTotal = 0;
        }

        TxtTotal.setText(String.format("%.2f", total));
        TxtSTotal.setText(String.format("%.2f", subTotal));
        TxtTImpuesto.setText(String.format("%.2f", total - subTotal));
    }
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(TxtId_Empleado, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(BtnVEmpleados, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(BtnVEmpleados, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(39, 39, 39)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
    ...
    private void BtnVventaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVventaActionPerformed
        if (TblVentas.getSelectedRowCount() == 1) {
            ...
            CbxTComprobante.setSelectedItem(tipoComprobante);
    ...
    private void obtenerNumero() {
        ...
        if (numComprobante.equals("")) {
            ...
            TxtNComprobante.setText(Integer.toString(num));
        }
    }
    ...
    private void BtnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGuardarActionPerformed
        ...
        String resp = "";
        resp = this.CONTROL.insertarVenta(Integer.parseInt(TxtId.getText()), (String) CbxTComprobante.getSelectedItem(), TxtScomprobante.getText(), TxtNComprobante.getText(), Double.parseDouble(TxtImpuesto.getText()), Double.parseDouble(TxtTotal.getText()), modeloDetalles);
        if (resp.equals("OK")) {
